...
public class Display extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static final String INDEX_OF_ITEM = "IndexOfListViewItem";
    private static final String POSITION_OF_ITEM = "PositionOfListViewItem";
    ...
    private AdvAdapter mAdAdapter;

    private FirebaseDatabase mFirebaseDatabase;
    private DatabaseReference mAdDatabaseReference, connectedRef;
   ...
   ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdListView = findViewById(R.id.messageListView);
        ...
        mAdDatabaseReference = mFirebaseDatabase.getReference().child("Advertisments");


        connectedRef = mFirebaseDatabase.getReference(".info/connected");


        keyOfCurrentNode = mAdDatabaseReference.push().getKey();
        ...
        mAdAdapter = new AdvAdapter(this, R.layout.item_ads, friendlyMessages);
        mAdListView.setAdapter(mAdAdapter);
        mAdListView.setSelectionFromTop(index, top);


        if (savedInstanceState != null) {
            Log.e("ssssV", "here");
            if (savedInstanceState.containsKey(INDEX_OF_ITEM)) {
                index = savedInstanceState.getInt(INDEX_OF_ITEM);
                Log.e("ssssV", "here" + index);


            }
            if (savedInstanceState.containsKey(POSITION_OF_ITEM)) {

                top = savedInstanceState.getInt(POSITION_OF_ITEM);
                Log.e("ssssV", "here" + top);
        ...
        mAdListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                adv_data selected_ad = mAdAdapter.getItem(position);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        index = mAdListView.getFirstVisiblePosition();
        View v = mAdListView.getChildAt(0);
        top = (v == null) ? 0 : (v.getTop() - mAdListView.getPaddingTop());
        Log.e("ssss", "" + index);
        Log.e("ssss", "" + top);


        outState.putInt(INDEX_OF_ITEM, index);
        outState.putInt(POSITION_OF_ITEM, top);
    ...
    private void EnableUpdateAndDelete() {
        mAdListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {

                final adv_data selected_ad = mAdAdapter.getItem(position);
    ...
    private void OnAttachDatabaseReadListener() {
        ...
        mAdDatabaseReference.addValueEventListener(mValueEventListener);
    }
    ...
    private void OnDetachDatabaseReadListener() {
        ...
        if (mValueEventListener != null) {
            mAdDatabaseReference.removeEventListener(mValueEventListener);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            mAdDatabaseReference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    mAdAdapter.clear();
    ...
    private boolean updateContent(String adNameNew, String catogery_item, String desNew, String city_choice, String mailNew, String ownerNameNew, String phoneNew, String path, String ID, String strDate, Double priceNew, String key) {
        ...
        mAdDatabaseReference.child(key).setValue(data);
    ...
    private void deleteItem(String keyOfNode) {
        ...
        mAdDatabaseReference.child(keyOfNode).removeValue();
    ...
    private void order() {
        ...
        if (orderFilter_choice.equals("الأقل سعر")) {
            query = mAdDatabaseReference.orderByChild("price");
            ...
            query = mAdDatabaseReference.orderByPriority();
        } else if (orderFilter_choice.equals("الاحدث")) {
            query = mAdDatabaseReference.orderByChild("date");
        }
