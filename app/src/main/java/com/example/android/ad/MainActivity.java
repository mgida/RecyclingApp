...
public class MainActivity extends AppCompatActivity implements TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adv_name_EditTxt.addTextChangedListener(this);
        adv_description_EditTxt.addTextChangedListener(this);
        owner_mail_EditTxt.addTextChangedListener(this);
        phone_EditTxt.addTextChangedListener(this);
        adv_ownerName.addTextChangedListener(this);
    ...
    public void onTextChanged(CharSequence charSequence, int start, int before, int count) {
        ...
        if (charSequence.toString().trim().length() > 0) {
            ...
            add_button.setEnabled(false);
            Toast.makeText(this, getString(R.string.validate_all_data), Toast.LENGTH_SHORT).show();
        }
